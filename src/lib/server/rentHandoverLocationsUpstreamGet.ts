...
/**
 * Gateway’de JWT gerektirmeyen `GET /rent/guest/handover-locations` proxysi.
 * Hem `/api/rent/guest/...` hem `/api/rent/public/...` BFF rotaları bunu kullanır.
 */
export async function rentHandoverLocationsUpstreamGet(req: Request): Promise<NextResponse> {
  try {
