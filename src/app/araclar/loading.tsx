export default function AraclarLoading() {
  return (
    <div className="flex min-h-[55vh] flex-col items-center justify-center gap-4 px-5 pb-20 pt-[calc(var(--header-h)+2rem)]">
      <div
        ...
        aria-hidden
      />
      <p className="text-sm font-medium text-text-muted">Uygun araçlar yükleniyor…</p>
      <p className="max-w-sm text-center text-xs text-text-muted/90">
        Tarih ve konuma göre filo sorgulanıyor; bu birkaç saniye sürebilir.
      </p>
    </div>
  );
}
